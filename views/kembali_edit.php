...
$ambil=  mysqli_query($koneksi, "SELECT * FROM kembali WHERE No_Buku ='$no_buku'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Update Data Pengembalian</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="Tanggal_Pengembalian" value="<?=$data['Tanggal_Pengembalian']?>"class="form-control">
                            </div>
                        </div>
						<div class="form-group">
                ...
                <div class="panel-footer">
                    <a href="?page=kembali&actions=tampil" class="btn btn-danger btn-sm">
                        Kembali Ke Data
                    </a>
                </div>
            </div>
...
if($_POST){
    ...
    $pengarang=$_POST['Pengarang'];
        //buat sql
    $sql="UPDATE kembali SET Nama_Anggota='$nama_anggota',Tanggal_Pengembalian='$tanggal_pengembalian', 
